...
def save_to_postgresql(the_osm_datas, the_url_to_the_database):
  ...
  the_osm_datas_as_records = the_osm_datas.dropna().to_dict('records')
  for a_record in the_osm_datas_as_records:
    ...
    #the_record_as_a_copy = { a_key : a_value for a_key, a_value in the_record_as_a_copy.items() if a_value.notnull()} # nan = null
